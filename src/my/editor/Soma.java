...
public class Soma {
    ...
    public Soma(BufferedImage img1, BufferedImage img2){
        l1 = img1.getWidth();
        a1 = img1.getHeight();
        imagemFinal1 = img1;
        l2 = img2.getWidth();
        ...
        for(int i=0; i<l2; i++){
         ...
         for(int i=0; i<finalL; i++){
            for(int j=0; j<finalA; j++){
                ...
                if(finalArray3[i][j][0]>255){
                    finalArray3[i][j][0] = 255;
                }
                if(finalArray3[i][j][1]>255){
                    finalArray3[i][j][1] = 255;
                }
                if(finalArray3[i][j][2]>255){
                    finalArray3[i][j][2] = 255;
                }
                if(finalArray3[i][j][3]>255){
                    finalArray3[i][j][3] = 255;
                }
